...
thrust= st.sidebar.slider("Thrust (N)", min_value=1.0, max_value=100.0, value=5.0, step=0.5)
dry_mass = st.sidebar.slider("Dry Mass (kg)", min_value=0.05, max_value=2.0, value=0.5, step=0.05)
diameter = st.sidebar.slider("Diameter (m)", min_value=0.01, max_value=0.5, value=0.04, step=0.1)
burn_time = st.sidebar.slider("Burn Time (s)", min_value=0.1, max_value=10.0, value=2.0, step=0.1)
propellant_mass = st.sidebar.slider("Propellant Mass (kg)", min_value=0.05, max_value=5.0, value=1.0, step=0.05)
